...
jar cfm ..\tools\shape2svgmap.jar SvgMapTools.mf org\svgmap\shape2svgmap\*.class org\svgmap\shape2svgmap\cds\*.class HyperBuilder.class Shape2ImageSVGMap.class Shape2SVGMap.class Shape2WGS84.class
