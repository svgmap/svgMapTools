...
//        	System.out.println("column:"+column + " val:"+value);
            ...
            } else if( "lon".equalsIgnoreCase(column) || "longitude".equalsIgnoreCase(column) || "lng".equalsIgnoreCase(column) || "long".equalsIgnoreCase(column) || "経度".equalsIgnoreCase(column) ){
